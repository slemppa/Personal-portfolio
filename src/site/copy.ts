...
const FI = {
  // NAV
  navManifesto: 'Periaatteet', navProjects: 'Projektit', navTech: 'Tech',
  ...
  manEyebrow: '— Periaatteet', manTitleA: 'Kuusi sääntöä, joilla', manTitleB: 'nämä on rakennettu.',
  manIntro: 'Sama lista ohjaa jokaista projektia — omaa ja asiakkaan.',
...
const EN: HomeCopy = {
  navManifesto: 'Principles', navProjects: 'Projects', navTech: 'Tech',
  ...
  manEyebrow: '— Principles', manTitleA: 'Six rules these', manTitleB: 'products were built by.',
  manIntro: 'The same list guides every project — my own and clients’.',
